...
public class EmployeeManagementSystem{
    ...
    public static void main(String[] args) throws IOException{
        ...
        while(list_structure && array_structure){
                System.out.print("Enter the first letter of the data strucure version you want to explore : ");
                System.out.print(" array, linkedList, exit : ");
                System.out.flush();
                int choice = getChar(); 
                switch(choice){
                    case 'l':
        ...
        while(list_struct){
                        System.out.print("LinkedList: Enter the first letter of : show, reset, ");
                        System.out.print("next, delete, initial, find, exit: ");
                        System.out.flush();
        ...
        while(array_struct){
                        System.out.print("Array: Enter the first letter of : show, next, ");
                        System.out.print("delete, initial, find, exit: ");
                        System.out.flush();
